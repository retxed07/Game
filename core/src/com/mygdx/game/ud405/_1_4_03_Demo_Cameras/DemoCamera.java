 ...
 */
public class DemoCamera implements InputProcessor {
    SplashScreen game;
    OrthographicProjection screen;
    ...
    public DemoCamera(SplashScreen game, OrthographicProjection screen) {
        this.game = game;
        this.screen = screen;
    ...
    public boolean keyDown(int keycode) {
        return Functions.onEscapeOrBack(screen, game, new ud405(game), keycode);
    }

package com.mygdx.game.ud405._1_3_04_Solution_ConnectTheDots;
...
public class ConnectTheDots implements Screen, InputProcessor {
    ...
    public ConnectTheDots(SplashScreen game) {
        this.game = game;

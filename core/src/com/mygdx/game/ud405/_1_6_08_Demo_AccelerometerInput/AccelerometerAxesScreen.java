package com.mygdx.game.ud405._1_6_08_Demo_AccelerometerInput;
...
public class AccelerometerAxesScreen extends ScreenAdapter implements InputProcessor {
    SplashScreen game;
    ...
    public AccelerometerAxesScreen(SplashScreen game) {
        this.game = game;
    }
